    ...
    <nav className="bg-gray-900 text-white p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-6">
          ...
          {userRole === "donor" && (
            <>
              <li><Link to="/donor/dashboard" className="hover:text-gray-400">Donor Dashboard</Link></li>
            </>
          )}
          {userRole === "recipient" && (
            <>
              <li><Link to="/recipient/dashboard" className="hover:text-gray-400">Recipient Dashboard</Link></li>
            </>
          )}
          {userRole === "hospital" && (
            <>
